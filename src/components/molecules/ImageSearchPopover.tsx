  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        ...
        sideOffset={8}
        collisionPadding={16}
        className="w-[420px] max-w-[calc(100vw-32px)] p-0 bg-surface-section border border-border-accent-light rounded-xl shadow-[0_8px_40px_rgba(0,0,0,0.5),0_0_0_1px_rgba(212,168,83,0.1)] flex flex-col overflow-hidden"
        style={{
          maxHeight:
