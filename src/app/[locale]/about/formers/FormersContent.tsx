...
export function FormersContent() {
  ...
  return (
    <section className="flex flex-col gap-12 md:gap-14 lg:gap-16 px-5 md:px-10 lg:px-20 py-16 md:py-20 lg:py-[80px] bg-surface-elevated">
      <MemberSection title={t("formerBoardTitle")} members={formerBoard} />
      <MemberSection title={t("formerAdvisoryTitle")} members={formerAdvisory} />
      <MemberSection title={t("electoralCouncilTitle")} members={electoralCouncil} />
      <MemberSection title={t("vapaNextGenTitle")} members={vapaNextGen} />
    </section>
  );
}
